...
import Graphics.Image qualified as Graphics
import Graphics.Image.Interface qualified as Graphics
import Polysemy
...
-- Graphics.Image Graphics.VS Graphics.RGB Double
...
run logSeverity darks biass lights workingDir = runM $
